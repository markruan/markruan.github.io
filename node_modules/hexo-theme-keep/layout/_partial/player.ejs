...
<li class="">
    ...
    <span class="aplayer-list-title">Crazy (Acoustic Version)</span>
    <span class="aplayer-list-author">David Benjamin</span>
</li>

<li class="aplayer-list-light">
    <span class="aplayer-list-cur" style="background-color: #b7daff;"></span>
    <span class="aplayer-list-index">2</span>
    <span class="aplayer-list-title">God is a girl</span>
    <span class="aplayer-list-author">Sasha Sloan</span>
</li>

<li>
    <span class="aplayer-list-cur" style="background-color: #b7daff;"></span>
    <span class="aplayer-list-index">3</span>
    <span class="aplayer-list-title">Valder Fields</span>
    <span class="aplayer-list-author">Tamas Wells</span>
</li>

    </ol>
</div>
<div class="aplayer-body" style="width: 400px;">
    <div class="aplayer-pic" style="background-color: #b7daff;">
    ...
    <div class="aplayer-info" style="display: block;">
        <div class="aplayer-music">
            <span class="aplayer-title">God is a girl</span>
            <span class="aplayer-author"> - Sasha Sloan</span>
        </div>
        <div class="aplayer-controller">
            <div class="aplayer-bar-wrap">
                <div class="aplayer-bar">
                    <div class="aplayer-loaded" style="width: 100%;"></div>
                    <div class="aplayer-played" style="width: 0.992289%; background: rgb(183, 218, 255);">
            ...
            <div class="aplayer-time aplayer-time-narrow">
                <span class="aplayer-time-inner">
                    <span class="aplayer-ptime">00:01</span> / <span class="aplayer-dtime">03:01</span>
                </span>
...
<script>
    let data =[{"name":"Crazy (Acoustic Version)","id":535048794,"artist":"David Benjamin"},{"name":"God is a girl","id":28952154,"artist":"Sasha Sloan"},{"name":"Valder Fields","id":2001320,"artist":"Tamas Wells"}]
    let list=[];
    for (var i = 0; i < data.length; i++) {
    	 var item={}
    	 item.url='https://music.163.com/song/media/outer/url?id='+data[i].id+'.mp3'
    	 item.name=data[i].name
    	 item.artist=data[i].artist
    	 list.push(item)
    }
